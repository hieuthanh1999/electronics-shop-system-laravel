...
Route::middleware(['maintenance'])->group(function () {
    ...
    Route::get('news', [HomeController::class, "indexNews"])->name('user.news');
    Route::get('news-details/{id}', [HomeController::class, "indexNewsDetails"])->name('user.news.details');
    Route::get('about', [HomeController::class, "index"])->name('user.about');
